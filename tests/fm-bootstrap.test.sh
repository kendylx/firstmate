...
devin profile is accepted^{"rules":[{"when":"devin work","use":{"harness":"devin","model":"swe-2"}}]}^empty^
unsupported devin effort is flagged^{"rules":[{"when":"devin work","use":{"harness":"devin","model":"swe-2","effort":"high"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - invalid effort: devin:high
